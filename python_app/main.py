...
def perform_db_operations(client, email, password):
    # Database details
    # db_name = "UserData"
...
# connection_uri = "mongodb+srv://rmon:Rw1151633@cluster0.vbuxqdk.mongodb.net/UserData"
...
def startprogram():
    ...
    user_found = False
    try:
        user_found = perform_db_operations(client, email, password)
    except:
